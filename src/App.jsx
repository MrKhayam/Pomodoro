...
const PomodoroTimer = () => {
  ...
  return (
    <div
      className={`min-h-screen mainContRes flex flex-col items-center justify-center bg-cover bg-center transition-all duration-700 ${
    ...
    >
      <div
        className={`absolute inset-0 ${
          isDarkMode ? "bg-black/60" : "bg-white/20"
        } backdrop-blur-sm`}
      ></div>
      ...
      <motion.div
        ...
        } p-12 rounded-3xl shadow-2xl backdrop-blur-md transition-all duration-300 relative overflow-hidden w-full max-w-2xl`}
      >
        <div
          className={`absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-amber-500 to-orange-500`}
        ></div>

        <div className="absolute top-4 right-4 iconRes flex space-x-4">
          <motion.button
            ...
            } hover:bg-orange-200 dark:hover:bg-amber-600 transition-colors duration-300`}
          >
        ...
        <motion.div
          ...
          className="flex mainBrainRes items-center justify-center mb-6"
        >
          {mode === "work" && (
            <Brain
              size={40}
              className={`${
                isDarkMode ? "text-orange-300" : "text-amber-600"
              } mr-3`}
            />
          )}
          {mode === "break" && (
          ...
          <h2
            className={`text-2xl font-semibold ${
              isDarkMode ? "text-orange-200" : "text-amber-800"
            }`}
          >
            {mode === "work"
              ? "Work Time"
        ...
        <motion.div
          ...
          className={`mainTextRes text-9xl font-bold mb-4 text-center ${
            isDarkMode ? "text-orange-100" : "text-amber-800"
          }`}
        >
        ...
        <div className="flex mainBtnRes justify-center space-x-6 mb-6">
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={toggleTimer}
            className="px-8 btnTopRes py-4 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white hover:from-amber-600 hover:to-orange-600 transition-all duration-300 flex items-center shadow-lg"
          ...
          >
            ...
            {isActive ? <h1>Pause</h1> : <h1>Start</h1>}
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={resetTimer}
            className="px-8 py-4 btnBottomRes rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white hover:from-orange-600 hover:to-red-600 transition-all duration-300 flex items-center shadow-lg"
          >
              ...
              <div className="space-y-4">
                <div>
                  <label
                    ...
                    className={`block mb-2 ${
                      isDarkMode ? "text-orange-200" : "text-amber-700"
                    }`}
                  >
                  ...
                  <div className="flex items-center">
                    <button
                      onClick={() => handleWorkDurationChange(workDuration - 1)}
                      className="p-2 bg-orange-200 rounded-l"
                    >
                      <ChevronLeft />
                    </button>
                    <input
                    ...
                    <button
                      onClick={() => handleWorkDurationChange(workDuration + 1)}
                      className="p-2 bg-orange-200 rounded-r"
                    >
                      <ChevronRight />
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <button
                      onClick={() =>
                        handleBreakDurationChange(breakDuration - 1)
                      }
                      className="p-2 bg-orange-200 rounded-l"
                    >
                      <ChevronLeft />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={sessions}
                    onChange={(e) =>
                      setSessions(Math.max(1, parseInt(e.target.value)))
                    }
